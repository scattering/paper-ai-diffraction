#!/bin/bash
#SBATCH -J vista-rruff-200k-po-1e
...
#SBATCH -t 02:00:00
#SBATCH -o /scratch/$USER/vista_rruff_conditioned_200k_po_1e_%j.out
#SBATCH -e /scratch/$USER/vista_rruff_conditioned_200k_po_1e_%j.err
...
DATA_PATH="/scratch/$USER/ai_diffraction_generated/rruff_conditioned_200k_po_v1_trainready.hdf5"
...
PY
python train.py --config config_rruff_conditioned_200k_po_1e_from_ic6gfmvm_physpe_coord.json
