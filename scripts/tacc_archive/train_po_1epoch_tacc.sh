...
#SBATCH -t 02:00:00
#SBATCH -o /scratch/09870/williamratcliff/vista_rruff_conditioned_200k_po_1e_%j.out
#SBATCH -e /scratch/09870/williamratcliff/vista_rruff_conditioned_200k_po_1e_%j.err
